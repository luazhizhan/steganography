...
from libs.api.text_lsb import encode
...
def catch_all(path):
    ...
    try:
        ...
        txt_io = encode(file.read(), payload, num_lsb)
        return send_file(txt_io, mimetype='text/plain')
    except ValueError as e:
        return make_response(jsonify({"message": str(e)}), 400)
    except Exception as e:
        print(e)
        return jsonify({"message": 'Unable to encode text file.'}), 400
